...
type
  TrpiGPIOAbstract = class(TObject)
      ...
      function readPin(pin: byte): boolean; virtual; abstract;
      procedure clearPin(pin: byte); virtual; abstract;
      procedure setPin(pin: byte); virtual; abstract;
      procedure setPullupMode(pin, mode: byte); virtual; abstract;
      procedure PWMWrite(pin: byte; value: longword); virtual; abstract;
  end;
